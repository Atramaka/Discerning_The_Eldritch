...
public class DTESoundRegistry {
    private static final DeferredRegister<SoundEvent> SOUND_EVENT = DeferredRegister.create(Registries.SOUND_EVENT, CursedSorcery.MOD_ID);

    /***
     * Spell Sounds
     */

    public static DeferredHolder<SoundEvent, SoundEvent> LAPSE_BLUE_EXPLODE = registerSoundEvent("lapse_blue_explode");

    public static DeferredHolder<SoundEvent, SoundEvent> LAPSE_BLUE_SUMMON = registerSoundEvent("lapse_blue_summon");

    public static DeferredHolder<SoundEvent, SoundEvent> LAPSE_BLUE_CAST = registerSoundEvent("blue_summon");

    public static DeferredHolder<SoundEvent, SoundEvent> DISMANTLE_SLICE = registerSoundEvent("dismantle_slice");
    ...
    private static DeferredHolder<SoundEvent, SoundEvent> registerSoundEvent(String name)
    {
        return SOUND_EVENT.register(name, () -> SoundEvent.createVariableRangeEvent
                (ResourceLocation.fromNamespaceAndPath(CursedSorcery.MOD_ID, name)));
    }
