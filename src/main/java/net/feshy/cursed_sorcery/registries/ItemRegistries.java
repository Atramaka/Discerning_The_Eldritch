...
import net.feshy.cursed_sorcery.items.armor.CrimsonStagArmorItem;
import net.feshy.cursed_sorcery.items.armor.EldritchWarlockArmorItem;
import net.feshy.cursed_sorcery.items.armor.EldritchWarlockHelmetItem;
import net.feshy.cursed_sorcery.items.armor.EldritchWarlockMaskItem;
import net.feshy.cursed_sorcery.items.armor.Geckolib.*;
import net.feshy.cursed_sorcery.items.curios.*;
import net.feshy.cursed_sorcery.items.custom.FadingSculkLantern;
import net.feshy.cursed_sorcery.items.spellbooks.BlackBookSpellbook;
import net.feshy.cursed_sorcery.items.spellbooks.DiaryOfDecaySpellbook;
import net.feshy.cursed_sorcery.items.spellbooks.GuardianGuidebookSpellbook;
import net.feshy.cursed_sorcery.items.spellbooks.StormWeaverTomeSpellbook;
import net.feshy.cursed_sorcery.items.staffs.BrokenLegendsStaff;
import net.feshy.cursed_sorcery.items.staffs.DTEStaffTier;
import net.feshy.cursed_sorcery.items.staffs.StaffOfVehemenceStaffItem;
...
public class ItemRegistries {
    ...
    // The Six Eyes
    public static final Supplier<CurioBaseItem> BLESSING_OF_SIX_EYES = ITEMS.register("blessing_of_six_eyes", SixEyesCurio::new);
