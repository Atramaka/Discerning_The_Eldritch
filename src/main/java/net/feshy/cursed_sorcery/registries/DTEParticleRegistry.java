...
import net.feshy.cursed_sorcery.particle.GlacialShadowParticleOptions;
import net.feshy.cursed_sorcery.particle.SoulFireSlashParticleOptions;
...
public class DTEParticleRegistry {
    public static final DeferredRegister<ParticleType<?>> PARTICLE_TYPES = DeferredRegister.create(Registries.PARTICLE_TYPE, CursedSorcery.MOD_ID);
    ...
    // Cleave
    public static final Supplier<SimpleParticleType> CLEAVE_PARTICLE = PARTICLE_TYPES.register("cleave", () -> new SimpleParticleType(false));
