...
import net.feshy.cursed_sorcery.compat.CompatManager;
...
public class DTECreativeModeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TAB =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, CursedSorcery.MOD_ID);
    ...
    public static final Supplier<CreativeModeTab> DTE_ITEMS_TAB = CREATIVE_MODE_TAB.register("dte_items_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ItemRegistries.CORRUPTED_CLOTH.get()))
                    .title(Component.translatable("creative_tab.cursed_sorcery.items"))
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(FurledMapItem.of(CursedSorcery.id("cultist_base"),
                                ResourceKey.create(Registries.DIMENSION, ResourceLocation.withDefaultNamespace("overworld")), Component.translatable("item.cursed_sorcery.cultist_base_map"), true));
                        // Curios
                        output.accept(ItemRegistries.BLESSING_OF_SIX_EYES.get());
