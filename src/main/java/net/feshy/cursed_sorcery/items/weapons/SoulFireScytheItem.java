...
import net.feshy.cursed_sorcery.registries.DTEDataComponentRegistry;
...
//                        new SpellDataRegistryHolder(SpellRegistries.SOUL_SET_ABLAZE, 1)
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        if (Screen.hasShiftDown())
        {
            ...
            tooltipComponents.add(
                    Component.translatable(
                            "tooltip.cursed_sorcery.active_ability",
        ...
        {
            tooltipComponents.add(Component.translatable("item.cursed_sorcery.more_details").withStyle(ChatFormatting.GRAY));
        }
    }
        ...
        if (livingEntity instanceof Player player)
        {
            ...
            if (ticks >= 10)
            {
                ...
                if (success)
                {
                    ...
                    //CursedSorcery.LOGGER.debug("Stacks cleared?: " + soulFireStacks);
