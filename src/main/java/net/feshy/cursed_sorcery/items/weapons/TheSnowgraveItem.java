...
//                        new SpellDataRegistryHolder(SpellRegistries.CRYSTALLINE_CARVER, 5)
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("item.cursed_sorcery.snowgrave.description_1").
                withStyle(ChatFormatting.GRAY).
                withStyle(ChatFormatting.ITALIC));
        tooltipComponents.add(Component.translatable("item.cursed_sorcery.snowgrave.description_2").
                withStyle(ChatFormatting.GRAY).
                withStyle(ChatFormatting.ITALIC));
    }
}
