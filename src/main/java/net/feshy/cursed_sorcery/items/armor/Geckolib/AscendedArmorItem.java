...
import net.feshy.cursed_sorcery.entity.armor.Geckolib.AscendedArmorModel;
...
public class AscendedArmorItem extends ImbuableGeckolibDTEArmorItem implements IArmorCapeProvider {
    ...
    public ResourceLocation getCapeResourceLocation() {
        return ResourceLocation.fromNamespaceAndPath(CursedSorcery.MOD_ID, "textures/models/armor/geckolib/ascended_armor_cape.png");
    }
