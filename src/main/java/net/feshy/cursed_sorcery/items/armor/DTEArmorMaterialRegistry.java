...
public class DTEArmorMaterialRegistry {
    private static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS = DeferredRegister.create(Registries.ARMOR_MATERIAL, CursedSorcery.MOD_ID);
    ...
    {
        List<ArmorMaterial.Layer> list = List.of(new ArmorMaterial.Layer(CursedSorcery.id(name)));
