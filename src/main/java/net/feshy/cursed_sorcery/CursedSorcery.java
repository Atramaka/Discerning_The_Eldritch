package net.feshy.cursed_sorcery;
...
import net.feshy.cursed_sorcery.compat.CompatRegistry;
import net.feshy.cursed_sorcery.effects.DestructiveRampageEffect;
import net.feshy.cursed_sorcery.entity.render.armor.CrimsonStagArmorRenderer;
import net.feshy.cursed_sorcery.entity.render.armor.EldritchWarlockArmorRenderer;
import net.feshy.cursed_sorcery.entity.render.armor.EldritchWarlockHelmetRenderer;
import net.feshy.cursed_sorcery.entity.render.armor.EldritchWarlockMaskRenderer;
import net.feshy.cursed_sorcery.entity.render.items.*;
import net.feshy.cursed_sorcery.items.armor.DTEArmorMaterialRegistry;
import net.feshy.cursed_sorcery.loot.DTELootModifiers;
import net.feshy.cursed_sorcery.networking.SprintBoostPacket;
...
@Mod(CursedSorcery.MOD_ID)
public class CursedSorcery
{
    public static final String MOD_ID = "cursed_sorcery";
    public static final Logger LOGGER = LogUtils.getLogger();

    public CursedSorcery(IEventBus modEventBus, ModContainer modContainer)
    {
...
//            AzArmorRendererRegistry.register(SixEyesCurioItemRenderer::new, ItemRegistries.BLESSING_OF_SIX_EYES.get());
//            CuriosRendererRegistry.register(
//                    ItemRegistries.BLESSING_OF_SIX_EYES.get(), SixEyesCurioRenderer::new
//            );
    ...
    {
        return ResourceLocation.fromNamespaceAndPath(CursedSorcery.MOD_ID, path);
    }
}
