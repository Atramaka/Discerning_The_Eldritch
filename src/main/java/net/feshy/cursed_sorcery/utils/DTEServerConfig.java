...
//            .define("Mend flesh exp gain", true);
    ...
    // Insanity System
    private static final ModConfigSpec.BooleanValue TERRAIN_DESTRUCTION_SYSTEM = BUILDER
            .comment("Defines whether or not spells destroy terrain.")
            .comment("Default is true")
            .define("Enable terrain destruction", true);
...
//            .define("Base Ascended One damage cap", 100);
    ...
    public static boolean enableTerrainDestruction;
    ...
    static void onLoad(final ModConfigEvent event)
    {
        ...
        enableTerrainDestruction = TERRAIN_DESTRUCTION_SYSTEM.get();
