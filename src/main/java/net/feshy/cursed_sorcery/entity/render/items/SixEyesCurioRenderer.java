...
@OnlyIn(Dist.CLIENT)
public class SixEyesCurioRenderer implements ICurioRenderer {
    private final SixEyesCurioItemRenderer curioRenderer = new SixEyesCurioItemRenderer();
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        ResourceLocation textureLocation = SixEyesCurioItemRenderer.TEX;
