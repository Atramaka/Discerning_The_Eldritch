...
public abstract class AbstractDarkSpell extends AbstractSpell {
    ...
    public CastResult canBeCastedBy(int spellLevel, CastSource castSource, MagicData playerMagicData, Player player) {
        ...
        {
            return new CastResult(CastResult.Type.FAILURE, Component.translatable("ui.discerning_the_eldritch.dark_cast_failure", new Object[]{this.getDisplayName(player)}).withStyle(ChatFormatting.RED));
